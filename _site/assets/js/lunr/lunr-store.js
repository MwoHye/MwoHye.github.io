var store = [{
        ...
        "excerpt":"  제 1절. 데이터모델의 이해 1. 모델링의 이해 모델링 : “다양한 현상을 표기법에 의해 표기하는 것” 특징 3가지 : 추상화, 단순화, 명확화 관점 3가지 : 데이터 관점, 프로세스 관점, 상관 관점 2. 데이터모델의 기본개념이해 데이터모델링 : “정보시스템을 구축하기 위한 데이터관점의 업무분석기법” 데이터모델이 제공하는 기능 시스템 가시화, 시스템 구조와 행동 명세화,...","categories": ["SQL"],
        "tags": ["SQL","SQLD","자격증"],
        "url": "/sql/SQLD-1/",
        "teaser": null
      },{
        ...
        "title": "SQL 정리(3/4) - 2과목 2장, SQL 활용",
        ...
        "excerpt":"   제 1절. 옵티마이저와 실행계획   제 2절. 인덱스 기본   제 3절. 조인 수행 원리  ","categories": ["SQL"],
        "tags": ["SQL","SQLD","자격증"],
        "url": "/sql/SQLD-4/",
        "teaser": null
      },{
