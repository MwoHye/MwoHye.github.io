var store = [{
        ...
        "excerpt":"  서 11월에 응시했던 SQLD 결과가 서론 응시 스펙 전공 자격증 직장인 응시 경험 (2년전 이후 2번째) 공부 시간 2주 공부 방법 2주 전 : 책 집중 리딩, 생각하며 이해하며 읽기, 내용 정리하며 이해 안된 이론들은 다른 블로그를 찾아보며 다양한 설명을 통해 복합적으로 이해해보려고 노력함. 공부한 내용은 블로그에 정리해가며 배운...","categories": ["SQLD"],
        "tags": ["SQL","SQLD","자격증"],
