var store = [{
        ...
        "excerpt":"  서론 : 비전공자, 직장인, 2회차 저는 심리학 출신으로 전략 기획 업무를 하고 있고, 2년 전때 1문제 차이로 탈랐했습니다. 이번에 회사에서 시험비용을 지원해주어 정말 오랜만에 시험을 보게 되었고, 공부했던 내용이 근육으로 남아 지금까지도 업무에 많은 도움을 주고 있습니다. 개인적으로 2년 전 불합격과 이번 합격은 저에게 여러모로 큰 차이가 있습니다. 보다...","categories": ["SQLD"],
        "tags": ["SQL","SQLD","자격증"],
