var store = [{
        ...
        "excerpt":"  공부 방법 D-14 : 노랭이 책 2번 + 인터넷 찾아보며 읽기(★★★), 키보드로 깨작깨작 써보기(★), 나만의 요약 정리하기 예전에는 노랭이 책을 형식적으로 읽었다면, 이번에는 한번 부담 없이 1회독 후, 생각하고 이해하며 한번 더 읽었습니다. 두 번째로 읽을 때는 노랭이 특유의 불충분한 설명을 인터넷의 다양한 게시글과 예시로 보완했는데, 이게 이해하는데 많은...","categories": ["SQLD"],
        "tags": ["SQL","SQLD","자격증"],
